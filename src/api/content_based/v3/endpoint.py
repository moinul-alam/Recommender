...
from src.models.content_based.v3.services.recommendation_service import RecommendationService
from src.models.content_based.v3.services.discovery_service import DiscoveryService
from src.models.content_based.v3.services.evaluation_service import EvaluationService
...
"""
@content_based_router_v3.post("/data-preparation")
...
Data Preprocessing
"""
@content_based_router_v3.post("/data-preprocessing")
...
Feature Engineering
"""
@content_based_router_v3.post("/feature-engineering")
...
Model Training
"""
@content_based_router_v3.post("/model-training")
...
Recommendation
"""
@content_based_router_v3.post("/similar")
async def recommendations(
    ...
    logging.info(f"Sending Request to Content Based Recommendation Service V3")
...
"""
@content_based_router_v3.post("/discover")
...
@content_based_router_v3.post("/evaluate-index", response_model=EvaluationResponse)
