...
from src.models.content_based.v3.pipeline.Recommender import Recommender
...
from src.models.content_based.v3.pipeline.NewDataPreparation import NewDataPreparation
...
class RecommendationService:
    ...
    def recommendation_service(
        ...
        try:
            ...
            if is_existing:
                logging.info(f'Existing media detected. Sending to Recommender Pipeline V3')
