...
class ModelTraining:
    def __init__(self, feature_matrix: pd.DataFrame, model_path: str, metric: str = "Inner Product"):
        ...
        Args:
            ...
            metric: Either "Inner Product" or "L2"
        """
        self.feature_matrix = feature_matrix
        self.model_path = model_path
        if metric not in ["Inner Product", "L2"]:
            raise ValueError("Metric must be either 'Inner Product' or 'L2'")
        self.metric = metric
